  ...
  function i(e, i, s, o) {
    e.hasOwnProperty(i) ||
      ...
      "function" == typeof CustomEvent &&
        t.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", { detail: { path: i, module: e[i] } })));
  }
  return (
        ...
        (i.supportsPassiveEvents = (function () {
          ...
          if (!i.isMS) {
            ...
            i.win.addEventListener &&
              ...
              (i.win.addEventListener("testPassive", i.noop, e), i.win.removeEventListener("testPassive", i.noop, e));
          }
          return t;
        })()),
        (i.charts = []),
 ...
 - ${i}: ${e}`),
      ...
      function C(e, i, o, r) {
        ...
        if (((o = o || {}), s.createEvent && (e.dispatchEvent || (e.fireEvent && e !== t))))
          (n = s.createEvent("Events")).initEvent(i, !0, !0), (o = m(n, o)), e.dispatchEvent ? e.dispatchEvent(o) : e.fireEvent(i, o);
        else if (e.hcEvents) {
          o.target ||
            m(o, {
          ...
          let t = [],
            ...
            r = !1;
          for (; s.hcEvents; )
            Object.hasOwnProperty.call(s, "hcEvents") && s.hcEvents[i] && (t.length && (r = !0), t.unshift.apply(t, s.hcEvents[i])),
      ...
      o.jQuery &&
        (o.jQuery.fn.highcharts = function () {
          ...
          if (this[0])
            return e[0] ? (new t[a(e[0]) ? e.shift() : "Chart"](this[0], e[0], e[1]), this) : i[g(this[0], "data-highcharts-chart")];
        });
      let T = {
        addEvent: function (e, i, s, o = {}) {
          ...
          a &&
            a.call(
              ...
              i,
              s,
              !!t.supportsPassiveEvents && { passive: void 0 === o.passive ? -1 !== i.indexOf("touch") : o.passive, capture: !1 }
            ),
            n[i] || (n[i] = []);
              ...
              k(e, function (i, d) {
                if (!n && s && s.indexOf(d) > -1 && o[d]) {
                  ...
                  for (let e = 0; e < Math.max(i.length, o[d].length); e++)
                    o[d][e] && (void 0 === i[e] ? (r[d][e] = o[d][e]) : ((r[d][e] = {}), t(i[e], o[d][e], r[d][e], n + 1)));
            ...
            t.forEach((t) => {
              if (t.length > 1)
                for (o = t.length - 1; o > 0; o--)
                  (s = t[o] - t[o - 1]) < 0 && !r ? (e?.(), (e = void 0)) : s && (void 0 === i || s < i) && (i = s);
            }),
            i
          );
        },
          ...
          return (
            this.useUTC
              ? ((n = this.Date.UTC.apply(0, arguments)),
                ...
                (n += a),
                a !== (h = this.getTimezoneOffset(n)) ? (n += h - a) : a - 36e5 !== this.getTimezoneOffset(n - 36e5) || f || (n -= 36e5))
    ...
    i(
      e,
      "Core/Defaults.js",
      [e["Core/Chart/ChartDefaults.js"], e["Core/Globals.js"], e["Core/Color/Palettes.js"], e["Core/Time.js"], e["Core/Utilities.js"]],
      function (t, e, i, s, o) {
          ...
          if ("object" == typeof e && void 0 !== e.stops) this.stops = e.stops.map((t) => new r(t[1]));
            ...
            if (((this.input = e = r.names[e.toLowerCase()] || e), "#" === e.charAt(0))) {
              ...
              7 === t
                ...
                : 4 === t && (s = [((3840 & i) >> 4) | ((3840 & i) >> 8), ((240 & i) >> 4) | (240 & i), ((15 & i) << 4) | (15 & i), 1]);
            }
          ...
          function g(t, e) {
            for (; t.length < d; ) {
              let i = t[0],
                s = e[d - t.length];
              if (
                (s && "M" === i[0] && ("C" === s[0] ? (t[0] = ["C", i[1], i[2], i[1], i[2], i[1], i[2]]) : (t[0] = ["L", i[1], i[2]])),
                t.unshift(i),
                a)
              ) {
                let e = t.pop();
          ...
          n(l) || ((f = arguments), (l = { duration: f[2], easing: f[3], complete: f[4] })),
            ...
            h(i, function (r, n) {
              c(e, n),
                ...
                (u = void 0),
                "d" === n && o(i.d)
                  ? ((g.paths = g.initPath(e, e.pathArray, i.d)), (g.toD = i.d), (d = 0), (u = 1))
                  : e.attr
                  ? (d = e.attr(n))
                  : ((d = parseFloat(s(e, n)) || 0), "opacity" !== n && (p = "px")),
                u || (u = r),
            ...
            d(t, (e, i) => {
              ...
              -1 === m.allowedAttributes.indexOf(i) && (s = !1),
                -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) &&
                  (s = l(e) && m.allowedReferences.some((t) => 0 === e.indexOf(t))),
        ...
        p = {
          ...
          each: function (t) {
            ...
            return (
              !!n(t) &&
              t
                .map((i, s) => u(e.body, o(h(i) ? i : { "@this": i }, { "@index": s, "@first": 0 === s, "@last": s === t.length - 1 })))
                .join("")
            );
          },
          ge: (t, e) => t >= e,
        ...
        for (; null !== (b = n.exec(t)); ) {
          ...
          if (v.isBlock && v.fn && (b[1] === `/${v.fn}` || o)) {
            if (S) !o && S--;
              ...
              void 0 === v.body ? ((v.body = i), (v.startInner = b.index + b[0].length)) : (v.elseBody = i),
                (v.find += i + b[0]),
                o || (h.push(v), (v = void 0));
            }
        ...
        -1 === e
          ...
          ? e &&
            ...
            ((n = e + +p[1]) >= 0
              ...
              : ((p[0] = p[0].split(".")[0] || 0), (t = e < 20 ? (p[0] * Math.pow(10, p[1])).toFixed(e) : 0), (p[1] = 0)))
          : (e = 2);
    ...
    i(e, "Core/Renderer/RendererUtilities.js", [e["Core/Utilities.js"]], function (t) {
      ...
      return (
        ((e || (e = {})).distribute = function t(e, n, a) {
          ...
          if (S > l) {
            for (
              r(e, (t, e) => (e.rank || 0) - (t.rank || 0)), x = (k = e[0].rank === e[e.length - 1].rank) ? p / 2 : -1, m = k ? x : p - 1;
              x && S > l;
    ...
    i(
      ...
      [e["Core/Animation/AnimationUtilities.js"], e["Core/Color/Color.js"], e["Core/Globals.js"], e["Core/Utilities.js"]],
      function (t, e, i, s) {
        ...
        class D {
          ...
          align(t, e, i) {
            ...
            t
              ? ((this.alignOptions = t),
                ...
                (!i || C(i)) && ((this.alignTo = r = i || "renderer"), y(d, this), d.push(this), (i = void 0)))
              ...
              if ((t.radialGradient ? (n = "radialGradient") : t.linearGradient && (n = "linearGradient"), n)) {
                if (
                  ...
                  "radialGradient" === n &&
                    u &&
                    !x(a.gradientUnits) &&
                    ((h = a), (a = w(a, o.getRadialAttr(u, h), { gradientUnits: "userSpaceOnUse" }))),
                  T(a, function (t, e) {
                    "id" !== e && f.push(e, t);
                  }),
                  T(d, function (t) {
            ...
            if (
              ...
              e && (t = b(e, i)),
                null === t.width || "auto" === t.width
                  ...
                  : "text" === s.nodeName.toLowerCase() && t.width && (o = this.textWidth = P(t.width)),
                (this.styles = t),
                o && !d && this.renderer.forExport && delete t.width;
              let r = w(t);
              s.namespaceURI === this.SVG_NS &&
                (["textOutline", "textOverflow", "width"].forEach((t) => r && delete r[t]), r.color && (r.fill = r.color)),
                m(s, r);
            }
            return (
              this.added &&
                ("text" === this.element.nodeName && this.renderer.buildText(this), t.textOutline && this.applyTextOutline(t.textOutline)),
              this
            );
          }
          dashstyleSetter(t) {
          ...
          getBBox(t, e) {
            ...
            if (
              (x(p) &&
                (-1 === (n = p.toString()).indexOf("<") && (n = n.replace(/[0-9]/g, "0")),
                (n += ["", d.rootFontSize, v, y, this.textWidth, h, c && c.textOverflow, c && c.fontWeight].join(","))),
              n && !t && (i = u[n]),
              !i)
            ) {
              if (f || d.forExport) {
              ...
              if (
                ((s = i.width),
                (o = i.height),
                f && (i.height = o = { "11px,17": 14, "13px,20": 16 }[`${v || ""},${Math.round(o)}`] || o),
                y)
              ) {
          ...
          constructor(t, e) {
            (this.onEvents = {}),
              (this.opacity = 1),
              (this.SVG_NS = c),
              (this.element = "span" === e ? f(e) : h.createElementNS(this.SVG_NS, e)),
              (this.renderer = t),
              v(this, "afterInit");
          }
          on(t, e) {
          ...
          strokeWidth() {
            ...
            return (
              t.indexOf("px") === t.length - 2
                ? (e = P(t))
                : "" !== t &&
                  (g((i = h.createElementNS(c, "rect")), { width: t, "stroke-width": 0 }),
          ...
          zIndexSetter(t, e) {
            ...
            if (
              (x(t)
                ? (n.setAttribute("data-z-index", t), (t = +t), this[e] === t && (u = !1))
                ...
                (p = !x((d = (l = h[g]).getAttribute("data-z-index")))),
                  l !== n &&
                    (t < 0 && p && !a && !g
                      ...
                      : (P(d) <= t || (p && (!x(t) || t >= 0))) && (r.insertBefore(n, h[g + 1]), (c = !0)));
    ...
    i(e, "Core/Renderer/SVG/SVGLabel.js", [e["Core/Renderer/SVG/SVGElement.js"], e["Core/Utilities.js"]], function (t, e) {
      ...
      class h extends t {
        ...
        onAdd() {
          this.text.add(this),
            this.attr({ text: n(this.textStr, ""), x: this.x || 0, y: this.y || 0 }),
        ...
        updateBoxSize() {
          ...
          let e = this.text,
            ...
            n = this.padding,
            a = (this.bBox =
              (!o(this.widthSetting) || !o(this.heightSetting) || this.textAlign) && i(e.textStr) ? e.getBBox() : h.emptyBBox);
          (this.width = this.getPaddedWidth()), (this.height = (this.heightSetting || a.height || 0) + 2 * n);
          let l = this.renderer.fontMetrics(e);
          if (
            ((this.baselineOffset = n + Math.min((this.text.firstLineMetrics || l).b, a.height || 1 / 0)),
        ...
        updateTextPadding() {
          ...
          if (!t.textPath) {
            ...
            i(this.widthSetting) &&
              ...
              (s += { center: 0.5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width)),
              (s !== t.x || e !== t.y) &&
                (t.attr("x", s), t.hasBoxWidthChanged && (this.bBox = t.getBBox(!0)), void 0 !== e && t.attr("y", e)),
              (t.x = s),
              (t.y = e);
          }
        }
    ...
    i(e, "Core/Renderer/SVG/Symbols.js", [e["Core/Utilities.js"]], function (t) {
      ...
      function o(t, i, o, r, n) {
        ...
        if (n) {
          ...
          (v.params = { start: h, end: p, cx: t, cy: i }),
            ...
            e(u) &&
              (((v = ["A", u, u, 0, b, e(n.clockwise) ? 1 - n.clockwise : 0, t + u * f, i + u * m]).params = {
                start: p,
                end: h,
                cx: t,
                cy: i,
              }),
              a.push(g ? ["M", t + u * x, i + u * y] : ["L", t + u * x, i + u * y], v)),
            g || a.push(["Z"]);
        }
        return a;
      }
      ...
      return {
        ...
        callout: function (t, e, s, o, r) {
          ...
          if (t + l > s - h) {
            if (d > e + h && d < e + o - h)
              c.splice(3, 1, ["L", t + s, d - 6], ["L", t + s + 6, d], ["L", t + s, d + 6], ["L", t + s, e + o - a]);
            else if (l < s) {
              let i = d < e + h,
                r = i ? e : e + o;
        ...
        return class {
          ...
          modifyDOM() {
            ...
            [].forEach.call(e.element.querySelectorAll("tspan.highcharts-br"), (t, s) => {
              t.nextSibling &&
                t.previousSibling &&
                (0 === s && 1 === t.previousSibling.nodeType && (e.firstLineMetrics = e.renderer.fontMetrics(t.previousSibling)),
              ...
              l = (t) => {
                ...
                i.forEach((i) => {
                  i.nodeType === r.Node.TEXT_NODE
                    ? h(i, t)
                    : (-1 !== i.className.baseVal.indexOf("highcharts-br") && (e.actualWidth = 0), l(i));
                });
              };
            l(e.element);
          }
              ...
              if (
                ("b" === h || "strong" === h
                  ? l
                    ...
                    : (n.fontWeight = "bold")
                  : ("i" === h || "em" === h) && (l ? (o.class = "highcharts-emphasized") : (n.fontStyle = "italic")),
        ...
        class B {
              ...
              u &&
                ...
                ((a = function () {
                  M(t, { left: 0, top: 0 }),
                    ...
                    M(t, { left: Math.ceil(h.left) - h.left + "px", top: Math.ceil(h.top) - h.top + "px" });
                })(),
                  ...
                  i = new t([
                    {
                      ...
                      children: [
                        ...
                        {
                          tagName: "rect",
                          attributes: { id: "hitme", width: 8, height: 8, "clip-path": `url(#${e})`, fill: "rgba(0,0,0,0.001)" },
                        },
                      ],
                    },
                  ]),
          ...
          crispLine(t, e, i = "round") {
            let s = t[0],
              o = t[1];
            return (
              C(s[1]) && s[1] === o[1] && (s[1] = o[1] = Math[i](s[1]) - (e % 2) / 2),
              C(s[2]) && s[2] === o[2] && (s[2] = o[2] = Math[i](s[2]) + (e % 2) / 2),
              t
            );
          }
          path(t) {
                ...
                ["width", "height"].forEach((t) => {
                  s[`${t}Setter`] = function (t, e) {
                    ...
                    r && "within" === r.backgroundSize && o && n && a && h
                      ? ((d = Math.min(o / a, n / h)), S(s, { width: Math.round(a * d), height: Math.round(h * d) }))
          ...
          pathToSegments(t) {
            ...
            for (let o = 0; o < t.length; o++)
              O(i[0]) && P(t[o]) && i.length === s[i[0].toUpperCase()] && t.splice(o, 0, i[0].replace("M", "L").replace("m", "l")),
            ...
            if ((o(t, { marginLeft: `${h}px`, marginTop: `${l}px` }), "SPAN" === t.tagName)) {
              ...
              if (a !== this.oldTextWidth) {
                ...
                (s > this.oldTextWidth || e > s) &&
                  ...
                  (o(t, { width: e > s || i ? a + "px" : "auto", display: "block", whiteSpace: u || "normal" }),
                  (this.oldTextWidth = a),
                  (l = !0));
              }
              (this.hasBoxWidthChanged = l),
                s !== this.cTT &&
                  ((h = e.fontMetrics(t).b),
                  r(i) && (i !== (this.oldRotation || 0) || n !== this.oldAlign) && this.setSpanRotation(i, p, h),
                  this.getSpanCorrection((!r(i) && this.textPxLength) || t.offsetWidth, h, p)),
        ...
        ((e || (e = {})).registerEventOptions = function (t, e) {
          (t.eventOptions = t.eventOptions || {}),
            o(e.events, function (e, o) {
              t.eventOptions[o] !== e &&
                (t.eventOptions[o] && (r(t, o, t.eventOptions[o]), delete t.eventOptions[o]),
      ...
      return class {
        ...
        addLabel() {
          ...
          c && d(w) && (w = r(c.lin2log(w))),
            i.dateTime &&
              (v
                ? (k = (M = o.time.resolveDTLFormat(s.dateTimeLabelFormats[(!s.grid && v.higherRanks[g]) || v.unitName])).main)
                : d(w) && (k = i.dateTime.getXDateFormat(w, s.dateTimeLabelFormats || {}))),
            (e.isFirst = x),
            (e.isLast = y);
          ...
          let A = (e) =>
              f.formatter
                ...
                : f.format
                ? ((e.text = i.defaultLabelFormatter.call(e, e)), t.format(f.format, e, o))
          ...
          L
            ...
            n(S) || e.movedLabel
              ? S &&
                S.textStr !== P &&
                !b &&
                (!S.textWidth || f.style.width || S.styles.width || S.css({ width: null }),
                S.attr({ text: P }),
          ...
          let n = this.axis,
            ...
            d = {
              x: t
                ...
                : n.left + n.offset + (n.opposite ? ((s && a.oldChartWidth) || a.chartWidth) - n.right - n.left : 0),
        ...
        handleOverflow(t) {
          ...
          d || "justify" !== i.overflow
            ...
            y &&
              (this.shortenLabel
                ? this.shortenLabel()
                : ((f.width = Math.floor(y) + "px"), (i.style || {}).textOverflow || (f.textOverflow = "ellipsis"), l.css(f)));
        }
        moveLabel(t, e) {
          let i = this,
            s = i.label,
          ...
          s && s.textStr === t
            ...
            !r &&
              (i.labelPos || s) &&
              ((n = i.labelPos || s.xy), (i.movedLabel = i.createLabel(t, e, n)), i.movedLabel && i.movedLabel.attr({ opacity: 0 }));
        }
        render(t, e, i) {
          let s = this.axis,
            o = s.horiz,
            ...
            d ||
              ...
              (this.gridLine = d =
                l
                  ...
                  .add(s.gridGroup))),
            d &&
              (c = s.getPlotLinePath({ value: n + h, lineWidth: d.strokeWidth() * i, force: "pass", old: t, acrossPanes: !1 })) &&
        ...
        renderLabel(t, e, i, s) {
          ...
          a &&
            ...
            (!this.isFirst || this.isLast || n.showFirstLabel) && (!this.isLast || this.isFirst || n.showLastLabel)
              ? !r || h.step || h.rotation || e || 0 === i || this.handleOverflow(t)
              : (f = !1),
            l && s % l && (f = !1),
            f && d(t.y)
              ? ((t.opacity = i), a[this.isNewLabel ? "attr" : "animate"](t).show(!0), (this.isNewLabel = !1))
        ...
        class N {
          ...
          defaultLabelFormatter(t) {
            ...
            if (n) f = `${this.value}`;
              ...
              for (; u-- && void 0 === f; )
                p >= (g = Math.pow(d, u + 1)) && (10 * o) % g == 0 && null !== l[u] && 0 !== o && (f = s(o / g, -1) + l[u]);
          ...
          translate(t, e, i, s, o, r) {
            ...
            let h = n.minPixelPadding,
              ...
              u = 0;
            if ((p || (p = n.transA), i && ((d *= -1), (c = n.len)), n.reversed && ((d *= -1), (c -= d * (n.sector || n.len))), e))
            ...
            return (
              M(this, "getPlotLinePath", v, function (t) {
                (u = f = Math.round((c = m((c = E(c, e.translate(n, void 0, void 0, r))), -1e5, 1e5)) + d)),
                  ...
                  A(c)
                    ? e.horiz
                      ? ((g = o), (x = h - e.bottom), (u = f = b(u, s, s + e.width)))
                      : ((u = s), (f = l - e.right), (g = x = b(g, o, o + e.height)))
                    : ((y = !0), (p = !1)),
                  (t.path =
                    y && !p
                      ? void 0
          ...
          getMinorTickPositions() {
            ...
            if (n && n / i < this.len / 3) {
              ...
              if (s)
                ...
                a = a.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(i), o, r, t.startOfWeek));
            ...
            this.isXAxis &&
              ...
              (o =
                y(t.min) || y(t.max) || y(t.floor) || y(t.ceiling)
                  ? null
                  : Math.min(
                      5 * (C(this.series.map((t) => (t.xIncrement ? t.xData?.slice(0, 2) : t.xData) || [])) || 0),
          ...
          getClosest() {
            ...
            if (this.categories) e = 1;
              ...
              this.series.forEach(function (t) {
                ...
                t.xData?.length === 1
                  ? i.push(t.xData[0])
                  : !t.noSharedTooltip && y(s) && t.reserveSpace() && (e = y(e) ? Math.min(e, s) : s);
              }),
          ...
          setTickInterval(t) {
            ...
            if (
              ...
              b
                ...
                : (l && y(d) && A(s) && A(o) && (o >= d ? ((L = d), (C = 0)) : s <= d && ((O = d), (k = 0))),
                  (this.min = E(D, L, o)),
                  (this.max = E(j, O, s))),
              A(this.max) &&
                A(this.min) &&
                (a &&
                  (this.positiveValuesOnly && !t && 0 >= Math.min(this.min, E(o, this.min)) && S(10, !0, i),
                  (this.min = x(a.log2lin(this.min), 16)),
                  (this.max = x(a.log2lin(this.max), 16))),
                this.range &&
                  A(o) &&
                  ((this.userMin = this.min = D = Math.max(o, this.minFromRange() || 0)),
              ...
              if (
                ...
                e ||
                  ...
                  b ||
                  !(w = this.max - this.min) ||
                  (!y(D) && C && (this.min -= w * C), y(j) || !k || (this.max += w * k)),
                ...
                !y(D) && this.min < t && o >= t
                  ...
                  : !y(j) && this.max > t && s <= t && (this.max = h.minRange ? Math.max(t, this.min + c) : t);
              }
          ...
          setTickPositions() {
            ...
            if (
              ...
              if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                ...
                for (; e <= 2 * t; )
                  if (
                    ((h = this.getLinearTickPositions(this.tickInterval, this.min, this.max)),
                    this.tickAmount && h.length > this.tickAmount)
                  )
                    this.tickInterval = z(this, (e *= 1.1));
                  else break;
              }
              h.length > this.len && (h = [h[0], h[h.length - 1]])[0] === h[1] && (h.length = 1),
                i && ((this.tickPositions = h), (l = i.apply(this, [this.min, this.max])) && (h = l));
            }
          ...
          alignToOthers() {
            ...
            if (
              ...
              ((!1 !== o.alignTicks && s.alignTicks) || r) && !1 !== s.startOnTick && !1 !== s.endOnTick && !e.logarithmic)
            ) {
              let s = (t) => {
          ...
          getThresholdAlignment(t) {
            if (
              ((!A(this.dataMin) || (this !== t && this.series.some((t) => t.isDirty || t.isDirtyData))) && this.getSeriesExtremes(),
              A(this.threshold))
            ) {
          ...
          adjustTickAmount() {
            let t = this,
              ...
              f = () => r.unshift(x(r[0] - p));
            if (
              (A(a) && ((u = a < 0.5 ? Math.ceil(a * (n - 1)) : Math.floor(a * (n - 1))), o.reversed && (u = n - 1 - u)),
              t.hasData() && A(s) && A(i))
            ) {
              let a = () => {
                (t.transA *= (h - 1) / (n - 1)),
          ...
          unsquish() {
            ...
            if (e) {
              if ((!t.staggerLines && (A(o) ? (c = [o]) : s < t.autoRotationLimit && (c = t.autoRotation)), c)) {
                ...
                for (let i of c)
                  (i === o || (i && i >= -90 && i <= 90)) &&
                    (e = (t = a(Math.abs(r / Math.sin(u * i)))) + Math.abs(i / 360)) < d &&
                    ((d = e), (l = i), (h = t));
              }
            } else h = a(0.75 * r);
            ...
            let { axisParent: t, chart: e, coll: i, options: s } = this,
              ...
              r = (e, r, n) =>
                o
                  ...
                  .attr({ zIndex: n })
                  .addClass(
                    `highcharts-${i.toLowerCase()}${r} ` + (this.isRadial ? `highcharts-radial-axis${r} ` : "") + (s.className || "")
                  )
                  .add(t);
            this.axisGroup ||
          ...
          renderTick(t, e, i) {
            ...
            (!s || (t >= this.min && t <= this.max) || (this.grid && this.grid.isColumn)) &&
              (o[t] || (o[t] = new n(this, t)), i && o[t].isNew && o[t].render(e, !0, -1), o[t].render(e));
          }
          render() {
            let t, e;
            let i = this,
          ...
          drawCrosshair(t, e) {
            ...
            if ((M(this, "drawCrosshair", { e: t, point: e }), t || (t = this.cross && this.cross.e), s && !1 !== (y(e) || !o))) {
              if (
                (o
                  ? y(e) && (a = E("colorAxis" !== this.coll ? e.crosshairPos : null, this.isXAxis ? e.plotX : this.len - e.plotY))
              ...
              (h = this.categories && !this.isRadial),
                l ||
                  ...
                  !r.styledMode &&
                    (l
                      .attr({
                        stroke: s.color || (h ? i.parse("#ccd3ff").setOpacity(0.25).get() : "#cccccc"),
              ...
              if ((s || (this.minorAutoInterval = void 0), t >= 0.5)) (t = Math.round(t)), (l = o.getLinearTickPositions(t, e, i));
                ...
                for (o = t > 0.3 ? [1, 2, 4] : t > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], r = p; r < i + 1 && !c; r++)
                  for (n = 0, a = o.length; n < a && !c; n++)
                    (h = this.log2lin(this.lin2log(r) * o[n])) > e && (!s || d <= i) && void 0 !== d && l.push(d),
                      d > i && (c = !0),
                      (d = h);
              } else {
                ...
                (t = r((t = n(u, this.minorAutoInterval, ((c - d) * g) / (f || 1))))),
            ...
            if (h && s)
              for (a && ((c = h.toString() === s.toString()), (d = 0)), l = 0; l < h.length; l += 2) {
                ...
                ("M" === t[0] || "L" === t[0]) &&
                  ...
                  ("M" === i[0] || "L" === i[0]) &&
                  ("M" === n[0] || "L" === n[0]) &&
                  (r && i[1] === t[1] ? ((i[1] += d), (n[1] += d)) : r || i[2] !== t[2] || ((i[2] += d), (n[2] += d)),
                  o.push(["M", t[1], t[2]], ["L", e[1], e[2]], ["L", n[1], n[2]], ["L", i[1], i[2]], ["Z"])),
                  (o.isFlat = c);
              }
            return o;
          }
        ...
        class c {
          ...
          render() {
            ...
            if (
              (!t.chart.styledMode &&
                (C
                  ? ((T.stroke = r || "#999999"), (T["stroke-width"] = d(e.width, 1)), e.dashStyle && (T.dashstyle = e.dashStyle))
                  : M && ((T.fill = r || "#e6e9ff"), x && ((T.stroke = e.borderColor), (T["stroke-width"] = x)))),
              (p.zIndex = c),
              (A += "-" + c),
            ...
            return (
              ...
              (w || !v.d) && S?.length
                ? v.attr({ d: S })
                : v && (S ? (v.show(), v.animate({ d: S })) : v.d && (v.hide(), b && (this.label = b = b.destroy()))),
      ...
      function (t, e, i, s, o) {
        ...
        class w {
          ...
          defaultFormatter(t) {
            ...
            return (
              (e = (e = [t.tooltipFooterHeaderFormatter(i[0])]).concat(t.bodyFormatter(i))).push(t.tooltipFooterHeaderFormatter(i[0], !0)),
              e
            );
          }
          destroy() {
          ...
          getAnchor(t, e) {
            ...
            let s = this.chart,
              ...
              a = s.plotLeft;
            if (
              ((t = M(t))[0].series && t[0].series.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()),
            ...
            if (!this.label) {
              ...
              if (
                (r
                  ...
                  : ((this.label = a
                      .label("", 0, 0, o.shape, void 0, void 0, o.useHTML, void 0, "tooltip")
            ...
            let { distance: s, chart: o, outside: r } = this,
              ...
              b = (i) => {
                ...
                return [i, n ? f : g, n ? t : e].concat(
                  r
                    ? [n ? x(t) : y(e), n ? m.left - s + x(d + a) : m.top - s + y(c + h), 0, n ? f : g]
                    : [n ? t : e, n ? d + a : c + h, n ? a : h, n ? a + o.plotWidth : h + o.plotHeight]
                );
              },
              v = b("y"),
              k = b("x"),
            ...
            if (((this.distance = S(C.tooltipOptions.distance, 16)), !1 === k)) this.hide();
              ...
              if (this.split && this.allowShared) this.renderSplit(k, a);
                ...
                let t = y,
                  o = v;
                if (
                  (e && r.isDirectTouch && ((t = e.chartX - i.plotLeft), (o = e.chartY - i.plotTop)),
          ...
          renderSplit(t, e) {
            ...
            function I(t, e, s, o, r = !0) {
              ...
              return (
                s
                  ? ((n = P ? 0 : j), (a = p(t - o / 2, w.left, w.right - o - (i.outside ? L : 0))))
                  : ((n = e - D), (a = p((a = r ? t - o - k : t + k), r ? a : w.left, w.right))),
                { x: a, y: n }
              );
            }
            b(t) && (t = [!1, t]);
                ...
                let r = e[o - 1] || { isHeader: !0, plotX: e[0].plotX, plotY: n, series: {} },
                  ...
                  d = (l.tt = (function (t, e, s) {
                    ...
                    return (
                      (o.isActive = !0),
                      o.attr({ text: s }),
                      v || o.css(M.style).attr({ stroke: M.borderColor || e.color || n.color || "#333333" }),
                      o
                    );
                  })(l.tt, r, s.toString())),
                  u = d.getBBox(),
        ...
        class C {
            ...
            return (
              ...
              void 0 === this.x && i
                ? void 0 === e
                  ...
                  : (this.x = e)
                : m(t.x) && i.options.relativeXValue && (this.x = i.autoIncrement(t.x)),
          ...
          optionsToObject(t) {
            ...
            if (m(t) || null === t) r[s[0]] = t;
              ...
              for (!i && t.length > o && ("string" == (n = typeof t[0]) ? (r.name = t[0]) : "number" === n && (r.x = t[0]), a++); h < o; )
                (i && void 0 === t[a]) || (s[h].indexOf(".") > 0 ? C.prototype.setNestedProperty(r, t[a], s[h]) : (r[s[h]] = t[a])),
                  a++,
                  h++;
          ...
          pos(t, e = this.plotY) {
            if (!this.destroyed) {
              ...
              if (m(i) && m(e))
                return (
                  t && ((a = r ? r.pos : o.plotLeft), (h = n ? n.pos : o.plotTop)),
                  o.inverted && r && n ? [n.len - e + h, r.len - i + a] : [i + a, e + h]
                );
            }
          }
          resolveColor() {
          ...
          update(t, e, i, s) {
            ...
            function d() {
              ...
              a && d && ((r.graphic = a.destroy()), delete r.hasMockGraphic),
                x(t, !0) &&
                  (a && a.element && t && t.marker && void 0 !== t.marker.symbol && (r.graphic = a.destroy()),
          ...
          setState(e, i) {
            ...
            if (((this.state = e), f && (y = s.markerAttribs(this, e)), this.graphic && !this.hasMockGraphic)) {
              if (
                (o && this.graphic.removeClass("highcharts-point-" + o), e && this.graphic.addClass("highcharts-point-" + e), !g.styledMode)
              ) {
                ...
                s.options.inactiveOtherPoints &&
                  ...
                  (this.dataLabels || []).forEach(function (e) {
                    e &&
                      ...
                      (e.animate({ opacity: t }, S), e.connector && e.connector.animate({ opacity: t }, S));
                  }),
              ...
              e &&
                ...
                y &&
                  (k
                    ...
                    : M &&
                      ((s.stateMarkerGraphic = k = g.renderer.symbol(M, y.x, y.y, y.width, y.height).add(s.markerGroup)),
                      (k.currentSymbol = M))),
                !g.styledMode && k && "inactive" !== this.state && k.attr(s.pointAttribs(this, e))),
                k && (k[e && this.isInside ? "show" : "hide"](), (k.element.point = this), k.addClass(this.getClassName(), !0));
            let C = r.halo,
              w = this.graphic || k,
            ...
            C && C.size && w && "hidden" !== T && !this.isCluster
              ? (x || (s.halo = x = g.renderer.path().add(w.parentGroup)),
                ...
                x.attr({
                  class:
                    "highcharts-halo highcharts-color-" + v(this.colorIndex, s.colorIndex) + (this.className ? " " + this.className : ""),
                  visibility: T,
                  zIndex: -1,
                }),
                (x.point = this),
                g.styledMode ||
                  x.attr(c({ fill: this.color || s.color, "fill-opacity": C.opacity }, t.filterUserAttributes(C.attributes || {}))))
      ...
      class k {
        ...
        destroy() {
          ...
          this.eventsToUnbind.forEach((t) => t()),
            (this.eventsToUnbind = []),
            !e.chartCount &&
              (k.unbindDocumentMouseUp && (k.unbindDocumentMouseUp = k.unbindDocumentMouseUp()),
              k.unbindDocumentTouchEnd && (k.unbindDocumentTouchEnd = k.unbindDocumentTouchEnd())),
        ...
        drag(t) {
          ...
          if (
            ...
            (p < s ? (p = s) : p > s + n && (p = s + n),
            u < r ? (u = r) : u > r + a && (u = r + a),
            (this.hasDragged = Math.sqrt(Math.pow(h - p, 2) + Math.pow(l - u, 2))),
            this.hasDragged > 10)
          ) {
            ...
            (e.hasCartesianSeries || e.mapView) &&
              ...
              f.attr({ class: "highcharts-selection-marker", zIndex: 7 }).add(),
              e.styledMode || f.attr({ fill: i.selectionMarkerFill || o("#334eff").setOpacity(0.25).get() })),
              f && f.attr(a),
        ...
        getChartCoordinatesFromPoint(t, e) {
          ...
          if (s && o) {
            ...
            return (
              ...
              e ? { chartX: o.len + o.pos - n, chartY: s.len + s.pos - i } : { chartX: i + s.pos, chartY: n + o.pos }
            );
          }
        ...
        getChartPosition() {
          ...
          let i = t.offsetWidth,
            s = t.offsetHeight;
          return (
            i > 2 && s > 2 && ((this.chartPosition.scaleX = e.width / i), (this.chartPosition.scaleY = e.height / s)), this.chartPosition
          );
        }
        getCoordinates(t) {
          let e = { xAxis: [], yAxis: [] };
        ...
        onContainerMouseDown(t) {
          ...
          (t = this.normalize(t)),
            ...
            (void 0 === t.button || i) && (this.zoomOption(t), i && t.preventDefault && t.preventDefault(), this.dragStart(t));
        }
            ...
            "touchstart" === t.type
              ...
              : s.length &&
                (g(i, "touchpan", { originalEvent: t }, () => {
                  m || (e.selectionMarker = m = p({ destroy: a, touch: !0 }, i.plotBox)),
        ...
        pinchTranslate(t, e, i, s, o, r) {
          this.zoomHor && this.pinchTranslateDirection(!0, t, e, i, s, o, r),
            this.zoomVert && this.pinchTranslateDirection(!1, t, e, i, s, o, r);
        }
        pinchTranslateDirection(t, e, i, s, o, r, n, a) {
          let h = this.chart,
            ...
            y = !m && e[1][c],
            b = function () {
              "number" == typeof w && Math.abs(x - y) > 20 && (M = a || Math.abs(C - w) / Math.abs(x - y)),
                (k = (u - C) / M + x),
        ...
        runPointActions(t, e, i) {
          ...
          this.unDocMouseMove ||
            ...
            s.axes.forEach(function (e) {
              ...
              !o || ((i = s.hoverPoint) && i.series[e.coll] === e) || (i = u(g, (t) => t.series && t.series[e.coll] === e)),
        ...
        scaleGroups(t, e) {
          ...
          i.series.forEach(function (s) {
            ...
            s.group &&
              ...
              (s.group.attr(o),
              s.markerGroup && (s.markerGroup.attr(t || s.getPlotBox("marker")), s.markerGroup.clip(e ? i.clipRect : null)),
        ...
        setHoverChartIndex(t) {
          ...
          s && s !== i && s.pointer.onContainerMouseLeave(t || { relatedTarget: i.container }),
                ...
                o.isInsidePlot(t.chartX - o.plotLeft, t.chartY - o.plotTop, { visiblePlotOnly: !0 }) && !o.openMenu
                  ? (e && this.runPointActions(t),
                    "touchmove" === t.type &&
                      (i =
                        !!(s = this.pinchDown)[0] &&
                        Math.sqrt(Math.pow(s[0].chartX - t.chartX, 2) + Math.pow(s[0].chartY - t.chartY, 2)) >= 4),
                    b(i, !0) && this.pinch(t))
                  : e && this.reset())
      ...
      function (t, e, i, s, o, r) {
        ...
        class A {
          ...
          colorizeItem(t, e) {
            ...
            if ((s?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode)) {
              ...
              o?.css(S(e ? this.itemStyle : s)),
                ...
                i?.attr(p({ fill: h || t.color, "fill-opacity": h ? 1 : l ?? 0.75 }));
            }
          ...
          renderItem(t) {
            ...
            !y &&
              ...
              !this.baseline &&
                ...
                o.squareSymbol &&
                  ((this.symbolWidth = k(o.symbolWidth, Math.max(this.symbolHeight, 16))),
          ...
          layoutItem(t) {
            ...
            s &&
              this.itemX - i + l > h &&
              ((this.itemX = i), this.lastLineHeight && (this.itemY += n + this.lastLineHeight + r), (this.lastLineHeight = 0)),
          ...
          render() {
            ...
            (this.itemX = s),
              ...
              t.styledMode ||
                d.attr({ stroke: i.borderColor, "stroke-width": i.borderWidth || 0, fill: i.backgroundColor || "none" }).shadow(i.shadow),
          ...
          align(t = this.chart.spacingBox) {
            ...
            /(lth|ct|rth)/.test(this.getAlignment()) && e.titleOffset[0] > 0
              ...
              this.group.align(
                S(i, { width: this.legendWidth, height: this.legendHeight, verticalAlign: this.proximate ? "top" : i.verticalAlign }),
                !0,
                t
              );
          }
    ...
    i(
      ...
      [e["Core/Globals.js"], e["Core/Defaults.js"], e["Core/Series/Point.js"], e["Core/Utilities.js"]],
      function (t, e, i, s) {
        var o;
    ...
    i(
      ...
      function (t, e, i, s, o, r, n, a, h, l) {
        ...
        class X {
            ...
            L(this, "bindAxes", null, function () {
              (e.axisTypes || []).forEach(function (o) {
                s[o].forEach(function (s) {
                  (t = s.options),
                    (N(i[o], 0) === s.index || (void 0 !== i[o] && i[o] === t.id)) && (E(e, s.series), (e[o] = s), (s.isDirty = !0));
                }),
          ...
          hasData() {
            return (
              (this.visible && void 0 !== this.dataMax && void 0 !== this.dataMin) || (this.visible && this.yData && this.yData.length > 0)
            );
          }
          ...
          autoIncrement(t) {
            ...
            i &&
              ...
              "day" === i
                ...
                : "year" === i && o.set("FullYear", n, o.get("FullYear", n) + a),
              (a = n.getTime() - r)),
            s && I(t))
              ? r + a
          ...
          setOptions(t) {
            ...
            return (
              (f.negativeColor || f.negativeFillColor) &&
                !f.zones &&
                ((e = { value: f[this.zoneAxis + "Threshold"] || f.threshold || 0, className: "highcharts-negative" }),
                a || ((e.color = f.negativeColor), (e.fillColor = f.negativeFillColor)),
                m.push(e)),
          ...
          getCyclic(t, e, i) {
            ...
            !e &&
              (k((o = N("color" === t ? this.options.colorIndex : void 0, this[n])))
                ? (s = o)
          ...
          getColor() {
            this.chart.styledMode
              ...
              ? (this.color = "#cccccc")
              : this.getCyclic("color", this.options.color || p.plotOptions[this.type].color, this.chart.options.colors);
          }
          getPointsCollection() {
              ...
              t.forEach(function (t, e) {
                ...
                u || I(p)
                  ? (-1 === (l = this.findPointIndex(d, c)) || void 0 === l
                      ? r.push(t)
                      : o[l] && t !== i.data[l]
                      ? (o[l].update(t, !1, null, !1), (o[l].touched = !0), n && (c = l + 1))
                      : o[l] && (o[l].touched = !0),
          ...
          setData(t, e = !0, i, s) {
            ...
            h.options.chart.allowMutatingData ||
              (a.data && delete o.options.data, o.userOptions.data && delete o.userOptions.data, (M = R(!0, t))),
              (t = M || t || []);
            let C = t.length;
            if (
              ...
              if (
                ...
                if (I((k = o.getFirstValidPoint(t)))) for (x = 0; x < C; x++) (p[x] = this.autoIncrement()), (u[x] = t[x]);
                  ...
                  if (f) {
                    ...
                    (m && ((v = m.indexOf("x")), (S = m.indexOf("y")), (v = v >= 0 ? v : 0), (S = S >= 0 ? S : 1)),
                    1 === k.length && (S = 0),
                    v === S)
                  )
                ...
                for (x = 0; x < C; x++)
                  (y = { series: o }), o.pointClass.prototype.applyOptions.apply(y, [t[x]]), o.updateParallelArrays(y, x);
            ...
            i && ((p = (c = i.getExtremes()).min), (u = c.max), (m = !!(i.categories && !i.names.length))),
              a &&
                ...
                (g[x - 1] < p || g[0] > u
                  ...
                  : e.yData &&
                    (g[0] < p || g[x - 1] > u) &&
                    ((g = (h = this.cropData(e.xData, e.yData, p, u)).xData), (f = h.yData), (d = h.start), (l = !0)));
          ...
          generatePoints() {
            ...
            for (h && a && (this.options.keys = !1), g = 0; g < r; g++)
              (p = n + g),
                a
                  ? (((u = new o(this, [i[g]].concat(G(s[g])))).dataGroup = this.groupMap[d + g]),
                    u.dataGroup.options && ((u.options = u.dataGroup.options), A(u, u.dataGroup.options), delete u.dataLabels))
                ...
                if (c) {
                  ...
                  if (
                    (!s &&
                      ...
                      ((i.graphic = s = h.renderer.symbol(t, a.x, a.y, a.width, a.height, n ? r : p).add(u)),
          ...
          markerAttribs(t, e) {
            ...
            e &&
              ((a = s.states[e]), (l = N((h = o.states && o.states[e]) && h.radius, a && a.radius, l && l + ((a && a.radiusPlus) || 0)))),
              (t.hasImage = r && 0 === r.indexOf("url")),
              t.hasImage && (l = 0);
            let d = t.pos();
            return (
              I(l) && d && ((n.x = d[0] - l), (n.y = d[1] - l), i.crisp && (n.x = Math.floor(n.x))), l && (n.width = n.height = 2 * l), n
            );
          }
          pointAttribs(t, e) {
          ...
          searchPoint(t, e) {
            ...
            return this.searchKDTree(
              { clientX: o ? i.len - t.chartY + i.pos : t.chartX - i.pos, plotY: o ? s.len - t.chartX + s.pos : t.chartY - s.pos },
              e,
              t
            );
          }
                  ...
                  (e.kdTree = (function t(i, s, o) {
                    ...
                    if (a)
                      return (
                        ...
                        { point: i[(n = Math.floor(a / 2))], left: t(i.slice(0, n), s + 1, o), right: t(i.slice(n + 1), s + 1, o) }
                      );
          ...
          update(t, e) {
            ...
            (u = u || r),
              ...
              (t = R(
                o,
                { index: void 0 === o.index ? i.index : o.index, pointStart: n?.series?.pointStart ?? o.pointStart ?? i.xData?.[0] },
          ...
          setState(t, e) {
            ...
            if (
              ...
              if ((t && ((h = n[t].lineWidth || h + (n[t].lineWidthPlus || 0)), (l = N(n[t].opacity, l))), o && !o.dashstyle && I(h)))
                for (let t of [o, ...this.zones.map((t) => t.graph)]) t?.animate({ "stroke-width": h }, a);
              r ||
        ...
        class tt {
          ...
          layOutTitles(t = !0) {
            ...
            ["title", "subtitle", "caption"].forEach(function (t) {
              ...
              if (o) {
                ...
                o.align(z({ y: "bottom" === n ? t : a + t, height: h }, r), !1, "spacingBox"),
                  r.floating || ("top" === n ? (e[0] = Math.ceil(e[0] + h)) : "bottom" === n && (e[2] = Math.ceil(e[2] + h)));
              }
            }, this),
            ...
            (this.titleOffset = e),
              ...
              !this.isDirtyBox &&
                o &&
                ((this.isDirtyBox = this.isDirtyLegend = o), this.hasRendered && t && this.isDirtyBox && this.redraw());
          }
          getContainerBox() {
          ...
          getChartSize() {
            ...
            (this.chartWidth = Math.max(0, e || s.width || 600)),
              (this.chartHeight = Math.max(0, _(i, this.chartWidth) || (s.height > 1 ? s.height : 400))),
              (this.containerBox = s);
          }
          temporaryDisplay(t) {
            let e = this.renderTo,
            ...
            if (t)
              for (; e && e.style; )
                e.hcOrigStyle && (D(e, e.hcOrigStyle), delete e.hcOrigStyle),
                  e.hcOrigDetached && (k.body.removeChild(e), (e.hcOrigDetached = !1)),
                  (e = e.parentNode);
            else
              for (
                ;
            ...
            m || ((this.chartBackground = m = e.rect().addClass("highcharts-background").add()), (k = "attr")),
              o
                ...
                : ((v = (b = t.borderWidth || 0) + (t.shadow ? 8 : 0)),
                  (S = { fill: n || "none" }),
                  (b || m["stroke-width"]) && ((S.stroke = t.borderColor), (S["stroke-width"] = b)),
              ...
              !o &&
                ...
                h && (r ? (h !== r.attr("href") && r.attr("href", h), r.animate(u)) : (this.plotBGImage = e.image(h, l, d, c, p).add()))),
          ...
          propFromSeries() {
            ...
            ["inverted", "angular", "polar"].forEach(function (n) {
              for (e = T[o.type], i = o[n] || (e && e.prototype[n]), t = r && r.length; !i && t--; )
              ...
              i.forEach(function (t) {
                ...
                if (Y(i)) {
                  ...
                  (s = ":previous" === i ? e.series[t.index - 1] : e.get(i)) &&
                    ...
                    (t.visible = $(t.options.visible, s.options.visible, t.visible)));
                }
              }),
          ...
          render() {
            ...
            for (let e of (this.setTitle(), W(this, "beforeMargins"), this.getStacks?.(), this.getMargins(!0), this.setChartSize(), t)) {
              ...
              if (e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !this.polar) {
                ...
                if (
                  (s.destroy(),
                  o && $(i.reserveSpace, !X(t.crossing)) && (r = o.getBBox().height + i.distance + Math.max(t.offset || 0, 0)),
                  r)
                ) {
                  o?.destroy();
                  break;
          ...
          showLoading(t) {
            ...
            r || (e.loadingDiv = r = L("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, e.container)),
              ...
              e.styledMode ||
                ...
                D(n, s.labelStyle),
                e.loadingShown ||
                  (D(r, { opacity: 0, display: "" }), g(r, { opacity: s.style.opacity || 0.5 }, { duration: s.showDuration || 0 }))),
              (e.loadingShown = !0),
              o();
          }
          hideLoading() {
          ...
          update(t, e, i, s) {
            ...
            p &&
              ...
              V(t, function (e, i) {
                a[i] && "function" == typeof a[i].update
                  ...
                  ? a[h[i]](e)
                  : "colors" !== i && -1 === a.collectionsWithUpdate.indexOf(i) && U(!0, a.options[i], t[i]),
                  ...
                  (K(t[e]).forEach(function (t, s) {
                    ...
                    r && (o = a.get(t.id)),
                      ...
                      !o &&
                        ...
                        (a.collectionsWithInit[e][0].apply(a, [t].concat(a.collectionsWithInit[e][1] || []).concat([!1])).touched = !0);
                  }),
                  i &&
            ...
            n || (X(u) && u !== a.chartWidth) || (X(g) && g !== a.chartHeight) ? a.setSize(u, g, s) : $(e, !0) && a.redraw(s),
            ...
            !t || t.resetSelection
              ...
              : t.xAxis.concat(t.yAxis).forEach(function (t) {
                  ...
                  ((i[n ? "zoomX" : "zoomY"] &&
                    E(h) &&
                    E(l) &&
                    e.isInsidePlot(h - e.plotLeft, l - e.plotTop, { axis: r, ignoreX: a, ignoreY: a })) ||
                    !E(e.inverted ? h : l)) &&
                    ((o = r.zoom(t.min, t.max)), r.displayBtn && (s = !0));
                });
            let r = e.resetZoomButton;
            s && !r ? e.showResetZoom() : !s && F(r) && (e.resetZoomButton = r.destroy()),
              o && e.redraw($(e.options.chart.animation, t && t.animation, e.pointCount < 100));
          }
          pan(t, e) {
            let i;
            let s = this,
                ...
                m &&
                  ...
                  e.series.forEach(function (t) {
                    ...
                    b || (b = { startMin: Number.MAX_VALUE, startMax: -Number.MAX_VALUE }),
                      X(i.dataMin) &&
                        X(i.dataMax) &&
                        ((b.startMin = Math.min($(t.options.threshold, 1 / 0), i.dataMin, b.startMin)),
                        (b.startMax = Math.max($(t.options.threshold, -1 / 0), i.dataMax, b.startMax)));
                  });
                ...
                (e.panningState = b),
                  e.isOrdinal ||
                    ...
                    e.series.length &&
                      ...
                      !s.resetZoomButton && x !== S && y !== k && a.match("y") && (s.showResetZoom(), (e.displayBtn = !1)),
                      (i = !0)),
                    (r[h] = n));
              }),
                V(r, (t, e) => {
    ...
    i(
      ...
      [e["Core/Animation/AnimationUtilities.js"], e["Core/Globals.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Utilities.js"]],
      function (t, e, i, s) {
        let { stop: o } = t,
          { composed: r } = e,
        ...
        function g() {
          ...
          C
            ...
            : ((this.fixedDiv = a(
                ...
                { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: (b.style?.zIndex || 0) + 2, top: 0 },
                void 0,
                !0
              )),
          ...
          o(this.container),
            ...
            x &&
              (h(x, { width: `${this.chartWidth}px`, height: `${this.chartHeight}px` }),
        ...
        function m() {
          ...
          this.scrollablePixelsX && (e.overflowX = "auto"),
            ...
            n(this.scrollingContainer, "scroll", () => {
              this.pointer &&
                (delete this.pointer.chartPosition, this.hoverPoint && (t = this.hoverPoint), this.pointer.runPointActions(void 0, t, !0));
            }),
        ...
        return {
          compose: function t(e, i, s) {
            u(r, t) &&
              (n(e, "afterInit", x),
              d(i.prototype, { applyFixed: g, moveFixedElements: f, setUpScrolling: m }),
        ...
        return class {
          ...
          setOffset(t, e, i, s, r, l) {
            ...
            if (p && m) {
              ...
              (m.x -= r),
                ...
                h(!i && u.crop, !0) &&
                  (s = a(p.x) && a(p.y) && f.isInsidePlot(p.x - e + (p.width || 0), p.y) && f.isInsidePlot(p.x + e, p.y)),
                p[s ? "show" : "hide"]();
            }
          ...
          getStackBox(t) {
            let e = this.axis,
              ...
              x = this.isNegative;
            return m
              ? { x: (x ? c : c - f) - i.plotLeft, y: p.height - u - n, width: f, height: n }
    ...
    i(
      ...
      function (t, e, i, s, o, r) {
        ...
        function v() {
          ...
          this.axes.forEach((t) => {
            ...
            this.series.forEach((e) => {
              ...
              e.options.stacking &&
                e.reserveSpace() &&
                (e.stackKey = [e.type, y(e.options.stack, ""), t ? i.top : i.left, t ? i.height : i.width].join(","));
            });
        }
        function S() {
          let t = this.stacking;
        ...
        function M(t, e, i, s) {
          return (
            !p(t) || t.x !== e || (s && t.stackKey !== s) ? (t = { x: e, index: 0, key: s, stackKey: s }) : t.index++,
        ...
        function T(t) {
          (this.is("column") || this.is("columnrange")) &&
            (this.options.centerInCategory && !this.options.stacking && this.chart.series.length > 1
        ...
        function A(t, e) {
          ...
          for (P.stacksTouched += 1, l = 0; l < v; l++) {
            (d = m[l]),
              ...
              L[a][d] ||
                (O[a]?.[d] ? ((L[a][d] = O[a][d]), (L[a][d].total = null)) : (L[a][d] = new o(t, t.options.stackLabels, !!s, d, C))),
              (r = L[a][d]),
              null !== u
            ...
            "percent" === g
              ? ((n = s ? w : T),
                (e = A && L[n]?.[d] ? ((n = L[n][d]).total = Math.max(n.total || 0, e) + Math.abs(u) || 0) : c(e + (Math.abs(u) || 0))))
              : "group" === g
              ? (f(u) && (u = u[0]), null !== u && e++)
              : (e = c(e + (u || 0))),
    ...
    i(
      ...
      [e["Core/Series/Series.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]],
      function (t, e, i) {
    ...
    i(
      ...
      [e["Core/Color/Color.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]],
      function (t, e, i) {
        let { parse: s } = t,
          {
            seriesTypes: { line: o },
            ...
            [this, ...this.zones].forEach((i, s) => {
              ...
              n
                ...
                this.chart.styledMode ||
                  ...
                  n.css({ pointerEvents: this.stickyTracking ? "none" : "auto" })),
                n[a](o),
                (n.startX = t.xMap),
          ...
          getGraphPath(t) {
            ...
            let r = o.prototype.getGraphPath,
              ...
              x = function (i, s, o) {
                ...
                m || h ? ((x = (h ? n[0] : n[1]) + m), (y = n[0] + m), (b = !!h)) : !a && t[s] && t[s].isNull && (x = y = g),
                  void 0 !== x &&
                    (c.push({ plotX: e, plotY: null === x ? f : l.getThreshold(x), isNull: b, isCliff: !0 }),
            ...
            for (let o = 0, r = t.length; o < r; ++o)
              a || (t[o].leftCliff = t[o].rightCliff = t[o].leftNull = t[o].rightNull = void 0),
                ...
                (i && !m) ||
                  (m || x(o, o - 1, "left"),
                  (i && !a && m) || (c.push(t[o]), d.push({ x: o, plotX: e, plotY: s })),
                  m || x(o, o + 1, "right"));
              ...
              s.forEach(function (t, a) {
                ...
                if (l[t] && !l[t].isNull)
                  i.push(l[t]),
                    [-1, 1].forEach(function (i) {
                      ...
                      if (r) {
                        ...
                        for (; i >= 0 && i < c; ) {
                          let s = d[i].index;
                          !(m = r.points[s]) && (s === e.index ? (l[t][o] = !0) : g[i] && (x = n[t].points[s]) && (h -= x[1] - x[0])),
                            (i += p);
                        }
                      }
                  ...
                  (f = h(f, 0)),
                    ...
                    i.push({ isNull: !0, plotX: o.translate(t, 0, 0, 0, 1), x: t, plotY: f, yBottom: f });
                }
              });
            }
            return i;
        ...
        return (
          (l.defaultOptions = n(o.defaultOptions, { threshold: 0, legendSymbol: "areaMarker" })),
    ...
    i(
      ...
      [e["Series/Spline/SplineSeries.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]],
      function (t, e, i) {
        let {
            area: s,
            area: { prototype: o },
        ...
        return (
          ...
          r(a.prototype, { getGraphPath: o.getGraphPath, getStackPoints: o.getStackPoints, drawGraph: o.drawGraph }),
    ...
    i(
      ...
      function (t, e, i, s, o, r, n) {
        ...
        class S extends o {
              ...
              : t.chart.series.forEach(function (e) {
                  ...
                  e.type === t.type &&
                    ...
                    (r.stacking && "group" !== r.stacking
                      ? (void 0 === n[(a = e.stackKey)] && (n[a] = h++), (i = n[a]))
                      : !1 !== r.grouping && (i = h++),
                    (e.columnIndex = i));
                });
            let l = Math.min(
                Math.abs(i.transA) *
                  ((!i.brokenAxis?.hasBreaks && i.ordinal?.slope) || e.pointRange || i.closestPointRange || i.tickInterval || 1),
                i.len
              ),
              d = l * e.groupPadding,
              c = (l - 2 * d) / (h || 1),
          ...
          pointAttribs(t, e) {
            ...
            t &&
              ...
              a && ((c = a.borderColor || c), (p = a.dashStyle || p), (u = a.borderWidth || u))),
              e &&
                t &&
        ...
        return (
          ...
          u(S.prototype, { directTouch: !0, getSymbol: d, negStacks: !0, trackerGroups: ["group", "dataLabelsGroup"] }),
    ...
    i(
      ...
      [e["Core/Animation/AnimationUtilities.js"], e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Utilities.js"]],
      function (t, e, i, s) {
        var o;
        ...
        return (
          (function (t) {
                ...
                k =
                  ...
                  (t.series.forceDL ||
                    ...
                    (f(i.inside, !!this.options.stacking) &&
                      s &&
                      n.isInsidePlot(c, a ? s.x + 1 : s.y + s.height - 1, { inverted: a, paneCoordinates: !0, series: r }))),
                M = t.pos();
              if (k && M) {
                u && e.attr({ align: g });
                let t = e.getBBox(!0),
                ...
                if (
                  ...
                  u
                    ? ((S = !1),
                      ...
                      (v = {
                        ...
                        y: s.y + (i.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[i.verticalAlign] * s.height,
                      }),
                  ...
                  (e += a[0]),
                    (i += a[1]),
                    (k =
                      n.isInsidePlot(e, i, { paneCoordinates: !0, series: r }) &&
            ...
            function o(t) {
              ...
              return (
                !e && i && (this.visible && i.show(), this.options.animation ? i.animate({ opacity: 1 }, t) : i.attr({ opacity: 1 })), i
              );
            }
            function b(t) {
              let e;
                  ...
                  t.forEach((t) => {
                    ...
                    y(S(x, t.dlOptions || t.options?.dataLabels)).forEach((l, d) => {
                      ...
                      if (
                        ...
                        !T ||
                          (c && h(M) && !!T.div == !!l.useHTML && ((T.rotation && l.rotation) || T.rotation === l.rotation)) ||
                          ((T = void 0), (A = !0)),
                        c &&
                          h(M) &&
                          (T
                            ? (w.text = M)
                            : (T = C
                                ? a.text(M, 0, 0, l.useHTML).addClass("highcharts-data-label")
                                : a.label(M, 0, 0, l.shape, void 0, void 0, l.useHTML, void 0, "data-label")) &&
                              T.addClass(
                        ...
                        o &&
                          !l.useHTML &&
                          (T.setTextPath(t.getDataLabelPath?.(T) || t.graphic, o),
            ...
            function v(t, e, i, s, o, r) {
              ...
              return (
                ...
                (p = (i.x || 0) + s.width - l) > n.plotWidth &&
                  ("left" === a && d <= 0 ? ((e.align = "right"), (e.inside = !0)) : (d += n.plotWidth - p), (u = !0)),
                (p = i.y + l) < 0 && ("bottom" === h && c >= 0 ? ((e.verticalAlign = "top"), (e.inside = !0)) : (c -= p), (u = !0)),
                (p = (i.y || 0) + s.height - l) > n.plotHeight &&
                  ("top" === h && c <= 0 ? ((e.verticalAlign = "bottom"), (e.inside = !0)) : (c += n.plotHeight - p), (u = !0)),
    ...
    i(
      ...
      [e["Core/Series/DataLabel.js"], e["Core/Globals.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]],
      function (t, e, i, s) {
        var o;
        let { composed: r } = e,
          { series: n } = i,
          ...
          (function (e) {
            function i(t, e, i, s, o) {
              ...
              if (p) {
                ...
                r && (s = { x: c - s.y - s.height, y: d - s.x - s.width, width: s.height, height: s.width }),
    ...
    i(
      ...
      [e["Series/Column/ColumnSeries.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]],
      function (t, e, i) {
    ...
    i(
      ...
      [e["Series/Scatter/ScatterSeriesDefaults.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]],
      function (t, e, i) {
      ...
      return (
        ((o = s || (s = {})).getCenter = function () {
          ...
          for (!i.angular || this instanceof e || (y[3] = 0), m = 0; m < 4; ++m)
            (x = y[m]), (u = m < 2 || (2 === m && /%$/.test(x))), (y[m] = l(x, [o, r, c, y[2]][m]) + (u ? s : 0));
          return (
            y[3] > y[2] && (y[3] = y[2]),
          ...
          animate(t) {
            ...
            t ||
              i.forEach(function (t) {
                ...
                i &&
                  o &&
                  (i.attr({ r: f(t.startR, e.center && e.center[3] / 2), start: s, end: s }),
                        ...
                        if (f) {
                          if (
                            (d &&
                              p(g) &&
                              f.distance > 0 &&
                              (void 0 === g.pos ? (C = "hidden") : ((S = g.size), (M = y.radialDistributionY(i, h)))),
                            l.justify)
                          )
                            k = y.justify(i, h, c, a);
                          else
                          ...
                          if (
                            ...
                            k - (v = h.getBBox().width) < b && 1 === n
                              ...
                              M - S / 2 < 0
                                ? (x[0] = Math.max(Math.round(-M + S / 2), x[0]))
                                : M + S / 2 > o && (x[2] = Math.max(Math.round(M + S / 2 - o), x[2])),
                              (f.sideOverflow = t);
                          }
                        }
                      });
              ...
              return (
                !n &&
                  ...
                  null !== s[1]
                    ...
                    : ((r = c(r, o, e[2] - t[0] - t[2])), (e[1] += (t[0] - t[2]) / 2)),
                  r < e[2]
                    ? ((e[2] = r),
                      (e[3] = Math.min(i.thickness ? Math.max(0, r - 2 * i.thickness) : Math.max(0, f(i.innerSize || 0, r)), r)),
                      this.translate(e),
            ...
            if (t && (!t.alignAttr || t.placed))
              return (
                ...
                (d = { left: "0", center: "0.5", right: "1" }[t.alignValue])
                  ? (h = +d * l)
                  : r(t.x) && Math.round(t.x) !== t.translateX && (h = t.x - (t.translateX || 0)),
                {
              ...
              for (let s of i)
                s.visible &&
                  (s.dataLabels || []).forEach((i) => {
                    let o = i.options || {};
                    (i.labelrank = a(o.labelrank, s.labelrank, s.shapeArgs?.height)),
                      o.allowOverlap ?? Number(o.distance) > 0 ? ((i.oldOpacity = i.opacity), (i.newOpacity = 1), d(i, t)) : e.push(i);
                  });
            };
            ...
            if (
              ...
              r
                ? ((h.start = l + f),
                  (s[1] = c + m * Math.cos(l)),
                  (s[2] = p + m * Math.sin(l)),
                  t.splice(e + 1, 0, ["A", i, i, 0, 0, 1, c + n * Math.cos(h.start), p + n * Math.sin(h.start)]))
                : ((h.end = d - f),
        ...
        (function (t) {
          ...
          function i(t, e) {
            ...
            r !== c &&
              ...
              r
                ? (((h = o(l, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0),
                  (this.currentResponsive = { ruleIds: r, mergedOptions: l, undoOptions: h }),
                  this.update(l, t, !0))
